...
// Прекрасный экстеншен который я получил на курсе iOS разработки в университете еще в 2023 году. (Сам файлик насколько знаю был создан еще в 2022 году)
// Очень упрощает работу с UIKit, а точнее логику добавления вьюшек и их верстки
// Всем кто это читает очень рекомендую тоже себе скачать, сохранить и пользоваться!)
